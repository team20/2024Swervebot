...
public class PoseEstimator {
	...
	/**
	 * The distance threshold for outlier detection (a sample {@code Pose} is
	...
	/**
	 * The {@code Pose} representing the pose estimated by this
	 * {@code PoseEstimator}.
	 */
	...
	/**
	 * The number of non-{@code null} sample {@code Pose}s that have been given to
	 * this {@code PoseEstimator}.
	 */
	int nonNullSamples = 0;

	/**
	 * The number of {@code null} sample {@code Pose}s that have been given to this
	 * {@code PoseEstimator}.
	 */
	int nullSamples = 0;

	/**
	 * The number of {@code Pose}s that have been considered outliers by this
	 * {@code PoseEstimator}.
	 */
	int outliers = 0;
	 ...
	 *                          sample {@code Pose} is considered an outlier and
	 *                          rejected if its distance from the estimated
	 *                          {@code Pose} is larger than this threshold)
	 */
	...
	/**
	 * Returns a {@code Pose} representing the pose estimated by this
	 * {@code PoseEstimator}.
	 * 
	 * @return a {@code Pose} representing the pose estimated by this
	 *         {@code PoseEstimator}
	 */
	 ...
	 * @param sample
	 *               a sample {@code Pose}
	 * @return {@code false} if the specified sample {@code Pose} is considered an
	 *         outlier (because the x- or
	 *         y-coordinate value of the sample {@code Pose} is different by more
	 *         than the threshold compared to the
	 *         estimated {@code Pose}) and thus rejected; {@code true} if this
	...
	/**
	 * Returns the rate (the number of sample {@code Pose}s per second) at which
	 * sample {@code Pose}s have been given to
	 * this {@code PoseEstimator}.
	 * 
	 * @return the rate (the number of sample {@code Pose}s per second) at which
	 *         sample {@code Pose}s have been given to
	 *         this {@code PoseEstimator}
	 */
	...
	/**
	 * Returns the rate at which {@code null} sample {@code Pose}s have been given
	 * to this {@code PoseEstimator}
	 * 
	 * @return the rate at which {@code null} sample {@code Pose}s have been given
	 *         to this {@code PoseEstimator}
	 */
	...
	/**
	 * Returns the number of outliers (i.e., sample {@code Pose}s that have been
	 * rejected by this
	 * {@code PoseEstimator}).
	 * 
	 * @return the number of outliers (i.e., sample {@code Pose}s that have been
	 ...
	 * orientation values) between the
	 * {@code Pose} estimated by this {@code PoseEstimator} and sample
	 * {@code Pose}s.
	 * 
	 ...
	 *         {@code Pose} is different by more than
	 *         the threshold compared to the estimated {@code Pose} maintained by
	 *         this {@code PoseEstimator};
	...
	/**
	 * Updates the estimated {@code Pose} based on the specified sample
	 * {@code Pose}.
	 * 
	 * @param sample
	 *               a sample {@code Pose}
