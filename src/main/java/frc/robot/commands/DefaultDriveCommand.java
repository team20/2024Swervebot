...
public class DefaultDriveCommand extends Command {
	...
	public void execute() {
		...
		/*
		 * double leftStickMagnitude = Math.sqrt( fwdSpeed * fwdSpeed + strSpeed *
		 * strSpeed);
		 ...
		 * double b = (Math.abs(leftStickMagnitude) * Math.sin(leftStickAngle +
		 * gyroAngleRad) - rotSpeed * sin135);
		 * // The y component of the FR and BR wheels
		 * double a = (Math.abs(leftStickMagnitude) * Math.sin(leftStickAngle +
		 * gyroAngleRad) - rotSpeed * sin225);
		 * //The x component of the FL and FR
		 * double d = (leftStickMagnitude * Math.cos(leftStickAngle + gyroAngleRad) -
		 * rotSpeed * cos135);
		 * //The x component of the BL and BR
		 * double c = (leftStickMagnitude * Math.cos(leftStickAngle + gyroAngleRad) -
		 * rotSpeed * cos45);
		 * double FRONTLEFTX = (leftStickMagnitude * Math.cos(leftStickAngle +
		 * gyroAngleRad) + rotSpeed * cos135);
		 * double FRONTLEFTY = (Math.abs(leftStickMagnitude) * Math.sin(leftStickAngle +
		 * gyroAngleRad) + rotSpeed * sin135);
		 * double BACKRIGHTX = (leftStickMagnitude * Math.cos(leftStickAngle +
		 * gyroAngleRad) + rotSpeed * cos45);
		 * double BACKRIGHTY = (Math.abs(leftStickMagnitude) * Math.sin(leftStickAngle +
		 * gyroAngleRad) + rotSpeed * sin225);
		 ...
		 * // Move the robot
		 * m_driveSubsystem.setSteerMotors(frontLeftAngle, frontRightAngle,
		 * backLeftAngle, backRightAngle);
		 * }
		 * m_driveSubsystem.setDriveMotors(frontLeftSpeed, frontRightSpeed,
