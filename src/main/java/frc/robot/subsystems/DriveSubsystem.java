...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    m_frontLeftSwerveModule.getSteerMotor().set(m_frontLeftSwerveModule.getPIDController().calculate(360 * m_frontLeftSwerveModule.getCANCoder().getAbsolutePosition().getValueAsDouble()));
    m_frontRightSwerveModule.getSteerMotor().set(m_frontRightSwerveModule.getPIDController().calculate(360 * m_frontRightSwerveModule.getCANCoder().getAbsolutePosition().getValueAsDouble()));
    m_backLeftSwerveModule.getSteerMotor().set(m_backLeftSwerveModule.getPIDController().calculate(360 * m_backLeftSwerveModule.getCANCoder().getAbsolutePosition().getValueAsDouble()));
    m_backRightSwerveModule.getSteerMotor().set(m_backRightSwerveModule.getPIDController().calculate(360 * m_backRightSwerveModule.getCANCoder().getAbsolutePosition().getValueAsDouble()));
